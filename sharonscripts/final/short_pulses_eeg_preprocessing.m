...
%% this part is intended to create eeg_all_trl/mat per subject
errors={};
all_chan = 'all';
...
%%  exclude bad trials - this is according to the excel (manual inspection checking if there was stimulation).
